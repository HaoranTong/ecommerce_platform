...
class TestUserRoleRepository:
    ...
    def test_delete_success(self, unit_test_db: Session):
        ...
        UserRoleRepository.delete(unit_test_db, unit_test_db, entity.id, entity.id)
    ...
    def test_delete_all_user_roles_success(self, unit_test_db: Session):
        ...
        # 执行Repository方法（使用主键参数）
        UserRoleRepository.delete_all_user_roles(unit_test_db, unit_test_db, entity.id)
...
class TestRolePermissionRepository:
    ...
    def test_delete_success(self, unit_test_db: Session):
        ...
        # 执行Repository方法（使用主键参数）
        RolePermissionRepository.delete(unit_test_db, unit_test_db, entity.id, entity.id)
    ...
    def test_delete_all_role_permissions_success(self, unit_test_db: Session):
        ...
        # 执行Repository方法（使用主键参数）
        RolePermissionRepository.delete_all_role_permissions(unit_test_db, unit_test_db, entity.id)
