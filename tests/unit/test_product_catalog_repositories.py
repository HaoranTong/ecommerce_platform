...
# 创建最小实体（只填必填字段）
    ...
    def test_find_by_name_and_parent_found(self, unit_test_db: Session):
        ...
        # 执行Repository方法
        result = CategoryRepository.find_by_name_and_parent(unit_test_db)  # TODO: 根据实际方法签名调整参数
...
class TestSKURepository:
    ...
    def test_update_single_field(self, unit_test_db: Session):
        ...
        # 准备测试数据
        from tests.factories.product_catalog_factories import SKUFactory
        SKUFactory._meta.sqlalchemy_session = unit_test_db
