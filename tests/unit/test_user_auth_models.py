...
class TestRolePermissionModel:
    ...
    def test_granted_at_field_mock(self, mocker):
        ...
        # 设置字段值
        mock_rolepermission.granted_at = None
        
        # 验证字段设置
        assert mock_rolepermission.granted_at == None
...
class TestUserModel:
    ...
    def test_locked_until_field_mock(self, mocker):
        ...
        # 验证字段设置
        assert mock_user.locked_until == None
    ...
    def test_last_login_at_field_mock(self, mocker):
        ...
        # 验证字段设置
        assert mock_user.last_login_at == None
...
class TestUserRoleModel:
    ...
    def test_assigned_at_field_mock(self, mocker):
        ...
        # 设置字段值
        mock_userrole.assigned_at = None
        
        # 验证字段设置
        assert mock_userrole.assigned_at == None
...
class TestSessionModel:
    ...
    def test_expires_at_field_mock(self, mocker):
        ...
        # 验证字段设置
        assert mock_session.expires_at == None
    ...
    def test_last_accessed_at_field_mock(self, mocker):
        ...
        # 验证字段设置
        assert mock_session.last_accessed_at == None
