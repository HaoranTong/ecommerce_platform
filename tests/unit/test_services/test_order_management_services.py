...
class TestOrderService:
    ...
    def test_service_with_mock_order_repository(self, mocker: MockerFixture):
        """测试Service使用Mock OrderRepository
        
        测试策略:
        - Mock OrderRepository的方法
        - 验证Service业务逻辑
        - 不依赖数据库
        
        示例: 测试获取Order的业务逻辑
        """
        print("\n🔧 测试Service Mock OrderRepository...")
        ...
        mock_repo = mocker.patch(
            'app.modules.order_management.repository.OrderRepository'
        )
