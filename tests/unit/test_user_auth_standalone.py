...
# Target path: tests/unit/test_user_auth_standalone.py
# Do NOT edit this file manually - regenerate from source models

"""
User_Auth 业务流程测试 (Standalone)
...
try:
    ...
    from app.modules.user_auth.models import Session, Permission, RolePermission, UserRole, User, Role
...
class TestUserAuthWorkflow:
    ...
    def test_complete_user_auth_workflow(self, unit_test_db: Session):
        """测试完整业务流程"""
        print(f"{NEWLINE}🔄 执行完整user_auth业务流程测试...")
