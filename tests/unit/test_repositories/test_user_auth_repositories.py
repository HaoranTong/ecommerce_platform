...
# 创建完整实体（填充所有字段）
    ...
    def test_count_count(self, unit_test_db: Session):
        """测试count - 计数功能"""
        # 准备测试数据
        entity0 = entity = User(username="测试数据0", email="email_测试数据0", password_hash="测试数据0", is_active=True, status="active", email_verified=True, phone_verified=True, two_factor_enabled=True, failed_login_attempts=1, role="user")
        unit_test_db.add(entity0)
        entity1 = entity = User(username="测试数据1", email="email_测试数据1", password_hash="测试数据1", is_active=True, status="active", email_verified=True, phone_verified=True, two_factor_enabled=True, failed_login_attempts=1, role="user")
        unit_test_db.add(entity1)
        entity2 = entity = User(username="测试数据2", email="email_测试数据2", password_hash="测试数据2", is_active=True, status="active", email_verified=True, phone_verified=True, two_factor_enabled=True, failed_login_attempts=1, role="user")
        unit_test_db.add(entity2)
        entity3 = entity = User(username="测试数据3", email="email_测试数据3", password_hash="测试数据3", is_active=True, status="active", email_verified=True, phone_verified=True, two_factor_enabled=True, failed_login_attempts=1, role="user")
        unit_test_db.add(entity3)
        entity4 = entity = User(username="测试数据4", email="email_测试数据4", password_hash="测试数据4", is_active=True, status="active", email_verified=True, phone_verified=True, two_factor_enabled=True, failed_login_attempts=1, role="user")
...
# 创建最小实体（用于更新测试）
    ...
    def test_get_user_count_count(self, unit_test_db: Session):
        ...
        # 准备测试数据
        entity0 = entity = Role(name="测试数据0", level=1)
        unit_test_db.add(entity0)
        entity1 = entity = Role(name="测试数据1", level=1)
        unit_test_db.add(entity1)
        entity2 = entity = Role(name="测试数据2", level=1)
        unit_test_db.add(entity2)
        entity3 = entity = Role(name="测试数据3", level=1)
        unit_test_db.add(entity3)
        entity4 = entity = Role(name="测试数据4", level=1)
        unit_test_db.add(entity4)
        unit_test_db.commit()
