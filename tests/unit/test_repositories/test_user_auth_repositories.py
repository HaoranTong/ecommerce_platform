...
class TestUserRoleRepository:
    ...
    def test_get_user_roles_found(self, unit_test_db: Session):
        ...
        # 准备测试数据
        entity = Role(name="关联数据", level=1)
        unit_test_db.add(entity)
        unit_test_db.commit()
        
        # 执行Repository方法
        result = UserRoleRepository.get_user_roles(unit_test_db, 1)
    ...
    def test_get_role_users_found(self, unit_test_db: Session):
        ...
        # 准备测试数据
        entity = User(username="关联数据", email="email_关联数据", password_hash="关联数据", is_active=True, status="active", email_verified=True, phone_verified=True, two_factor_enabled=True, failed_login_attempts=1, role="user")
        unit_test_db.add(entity)
        unit_test_db.commit()
        
        # 执行Repository方法
        result = UserRoleRepository.get_role_users(unit_test_db, 1, 0, 100)
    ...
    def test_get_role_users_not_found(self, unit_test_db: Session):
        ...
        # 执行Repository方法（查询不存在的数据）
        result = UserRoleRepository.get_role_users(unit_test_db, 999999, 0, 100)
...
class TestRolePermissionRepository:
    ...
    def test_get_role_permissions_found(self, unit_test_db: Session):
        ...
        # 准备测试数据
        entity = Permission(name="关联数据", resource="关联数据", action="关联数据")
        unit_test_db.add(entity)
        unit_test_db.commit()
        
        # 执行Repository方法
        result = RolePermissionRepository.get_role_permissions(unit_test_db, 1)
