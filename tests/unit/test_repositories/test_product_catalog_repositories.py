...
class TestCategoryRepository:
    ...
    def test_list_query(self, unit_test_db: Session):
        ...
        # 执行Repository方法
        results = CategoryRepository.list(unit_test_db, entity.parent_id, False, 0, 100)
    ...
    def test_children_query(self, unit_test_db: Session):
        ...
        # 执行Repository方法
        results = CategoryRepository.children(unit_test_db, entity.parent_id)
    ...
    def test_count_children_query(self, unit_test_db: Session):
        ...
        # 执行Repository方法
        result = CategoryRepository.count_children(unit_test_db, entity.parent_id)
    ...
    def test_find_by_name_and_parent_found(self, unit_test_db: Session):
        ...
        # 执行Repository方法
        result = CategoryRepository.find_by_name_and_parent(unit_test_db, entity.name, entity.parent_id, None)
    ...
    def test_find_by_name_and_parent_not_found(self, unit_test_db: Session):
        ...
        result = CategoryRepository.find_by_name_and_parent(unit_test_db, "nonexistent_value", 999999, None)
...
class TestProductRepository:
    ...
    def test_list_query(self, unit_test_db: Session):
        ...
        # 执行Repository方法
        results = ProductRepository.list(unit_test_db, 0, 100)
...
class TestSKURepository:
    ...
    def test_list_query(self, unit_test_db: Session):
        ...
        # 执行Repository方法
        results = SKURepository.list(unit_test_db, entity.product_id, False)
    ...
    def test_count_by_category_ids_query(self, unit_test_db: Session):
        ...
        # 执行Repository方法
        result = SKURepository.count_by_category_ids(unit_test_db, [1])
