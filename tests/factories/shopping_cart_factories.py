...
class CartItemFactory(factory.alchemy.SQLAlchemyModelFactory):
    ...
    quantity = factory.Faker('random_int', min=1, max=999)
...
class ShoppingCartFactoryManager:
    ...
    def create_sample_data(session) -> dict:
        ...
        from tests.factories.product_catalog_factories import ProductFactory, CategoryFactory, BrandFactory
        ...
        # 6. 创建CartItem
        data['cartitem'] = CartItemFactory(cart_id=data['cart'].id, sku_id=data['product'].id)
