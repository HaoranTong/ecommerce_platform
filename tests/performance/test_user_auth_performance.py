...
class TestUserAuthConcurrency:
    ...
    async def test_mixed_workload_performance(self, async_api_client):
        ...
        async def write_operation():
            ...
            try:
                # 使用确定的HTTP方法
                response = await async_api_client.post("/api/v1/user-auth/verification-code", json=test_data, headers=headers)
        ...
        async def user_session():
            ...
            try:
                ...
                operations = [
                    ...
                    ("POST", "/api/v1/user-auth/verification-code", test_data),  # 更新用户信息
                ]
