...
@pytest.mark.slow
class TestUser_AuthPerformance:
    """性能测试"""
    
    def test_user_auth_create_performance(self, mysql_integration_db: Session):
        """测试user_auth创建操作性能"""
    ...
    def test_user_auth_query_performance(self, mysql_integration_db: Session):
        """测试user_auth查询操作性能"""
        service = User_AuthService(mysql_integration_db)
    ...
    def test_user_auth_concurrent_access(self, mysql_integration_db: Session):
        """测试user_auth并发访问性能"""
        service = User_AuthService(mysql_integration_db)
