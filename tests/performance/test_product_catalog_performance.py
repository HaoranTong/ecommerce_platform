...
# Target path: tests/performance/test_product_catalog_performance.py
...
class TestProductCatalogResponseTime:
    ...
    async def test_api_response_time_p50(self, async_api_client):
        ...
        for _ in range(warmup_count):
            await async_api_client.get("/api/v1/product-catalog/categories", headers=headers)
        ...
        async def write_operation():
            ...
            try:
                ...
                if "POST" == "GET":
                    ...
                    response = await async_api_client.put("/api/v1/product-catalog/categories", json=test_data, headers=headers)
                else:
                    # POST请求
                    test_data = {
                        "name": fake.company()[:50],
        ...
        async def user_session():
            ...
            try:
                ...
                operations = [
                    ...
                    ("GET", "/api/v1/product-catalog/categories"),  # 再次获取用户信息
                ]
