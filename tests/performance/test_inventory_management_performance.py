...
class TestInventoryManagementResponseTime:
    ...
    async def test_api_response_time_p50(self, async_api_client):
        ...
        for _ in range(warmup_count):
            await async_api_client.get("/api/v1/inventory-management/low-stock", headers=headers)
        ...
        for _ in range(100):
            ...
            response = await async_api_client.get("/api/v1/inventory-management/low-stock", headers=headers)
    ...
    async def test_sustained_load(self, async_api_client):
        ...
        while time.time() - start_time < duration_seconds:
            ...
            for _ in range(requests_per_second):
                task = async_api_client.get("/api/v1/inventory-management/low-stock", headers=headers)
    ...
    async def test_peak_load_handling(self, async_api_client):
        ...
        async def user_session():
            ...
            try:
                # 用户典型操作序列（只使用读操作）
                operations = [
                    ("GET", "/api/v1/inventory-management/low-stock"),  # 获取当前用户信息
                    ("GET", "/api/v1/inventory-management/"),  # 列表
                    ("GET", "/api/v1/inventory-management/low-stock"),  # 再次获取用户信息
                ]
...
class TestInventoryManagementBenchmark:
    ...
    async def test_performance_regression(self, async_api_client):
        ...
        throughput_tasks = [async_api_client.get("/api/v1/inventory-management/low-stock", headers=headers) for _ in range(100)]
