...
# Target path: tests/e2e/test_inventory_management_workflows.py
...
@pytest.mark.e2e
@pytest.mark.asyncio
class TestInventoryManagementE2EWorkflow:
    """
    库存管理模块端到端测试
    ...
    async def test_complete_business_workflow(self, async_api_client):
        ...
        response = await async_api_client.post(
            f"/api/v1/inventory-management/stock/batch",
            json=create_data,
            headers=headers
        )
        ...
        response = await async_api_client.get(
            f"/api/v1/inventory-management/low-stock",
            headers=headers
        )
        ...
        if item_id:
            ...
            response = await async_api_client.put(
                f"/api/v1/inventory-management/threshold/{item_id}",
                json=update_data,
                headers=headers
            )
        ...
        if item_id:
            ...
            response = await async_api_client.delete(
                f"/api/v1/inventory-management/reserve/{item_id}",
                headers=headers
            )
    ...
    async def test_concurrent_user_workflow(self, async_api_client):
        ...
        async def single_user_workflow(user_id):
            ...
            # 执行简单的CRUD操作
            response = await async_api_client.get(f"/api/v1/inventory-management/", headers=headers)
...
@pytest.mark.e2e
@pytest.mark.asyncio
class TestInventoryManagementE2EErrorHandling:
    """
    库存管理模块错误处理E2E测试
    ...
    async def test_unauthorized_access_handling(self, async_api_client):
        ...
        # 不提供认证token
        response = await async_api_client.get(f"/api/v1/inventory-management/")
    ...
    async def test_resource_not_found_handling(self, async_api_client):
        ...
        # 访问不存在的资源
        response = await async_api_client.get(
            f"/api/v1/inventory-management/999999",
            headers=headers
        )
