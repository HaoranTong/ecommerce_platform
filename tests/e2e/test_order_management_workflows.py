...
# Target path: tests/e2e/test_order_management_workflows.py
...
@pytest.mark.e2e
@pytest.mark.asyncio
class TestOrderManagementE2EWorkflow:
    """
    订单管理模块端到端测试
    ...
    async def test_complete_business_workflow(self, async_api_client):
        ...
        response = await async_api_client.post(
            f"/api/v1/order-management/orders",
            json=create_data,
            headers=headers
        )
    ...
    async def test_concurrent_user_workflow(self, async_api_client):
        ...
        async def single_user_workflow(user_id):
            ...
            # 执行简单的CRUD操作
            response = await async_api_client.get(f"/api/v1/order-management/", headers=headers)
...
@pytest.mark.e2e
@pytest.mark.asyncio
class TestOrderManagementE2EErrorHandling:
    """
    订单管理模块错误处理E2E测试
    ...
    async def test_unauthorized_access_handling(self, async_api_client):
        ...
        # 不提供认证token
        response = await async_api_client.get(f"/api/v1/order-management/")
    ...
    async def test_resource_not_found_handling(self, async_api_client):
        ...
        # 访问不存在的资源
        response = await async_api_client.get(
            f"/api/v1/order-management/999999",
            headers=headers
        )
