...
# Target path: tests/security/test_product_catalog_security.py
...
class TestProductCatalogDataProtection:
    ...
    async def test_data_access_control(self, async_api_client):
        ...
        response = await async_api_client.get(
            f"/api/v1/product_catalog/user/{admin_user_id}/private",
            headers=headers
        )
        ...
        response = await async_api_client.put(
            f"/api/v1/product_catalog/user/{admin_user_id}/profile",
