...
def log_security_event(
    event_type: str, message: str, user_data: Dict[str, Any] = None, **kwargs
):
    """记录安全事件的便捷函数"""
...
class SecurityLogger:
    ...
    def log_member_update(self, user_id: int, data: Dict[str, Any]):
        ...
        """
        message = (
            f"会员信息更新: user_id={user_id}, fields={data.get('updated_fields')}"
        )
        log_security_event(
    ...
    def log_point_transaction(self, user_id: int, data: Dict[str, Any]):
        ...
        message = (
            f"积分交易: user_id={user_id}, type={transaction_type}, points={points}"
        )
        log_security_event(
    ...
    def log_benefit_usage(self, user_id: int, data: Dict[str, Any]):
        ...
        message = (
            f"权益使用: user_id={user_id}, benefit={benefit_name} ({benefit_type})"
        )
        log_security_event(
    ...
    def log_activity_creation(self, data: Dict[str, Any]):
        ...
        log_security_event(event_type="activity_creation", message=message, **data)
    ...
    def log_activity_participation(self, user_id: int, data: Dict[str, Any]):
        ...
        message = (
            f"活动参与: user_id={user_id}, activity={activity_title} (ID:{activity_id})"
        )
        log_security_event(
