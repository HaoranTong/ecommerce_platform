...
class Order(Base):
    ...
    discount_amount = Column(
        Numeric(10, 2), nullable=False, default=0.00, comment="折扣金额"
    )
    total_amount = Column(
        Numeric(10, 2), nullable=False, default=0.00, comment="总金额"
    )
...
class OrderStatusHistory(Base):
    ...
    # 审计字段
    created_at = Column(
        DateTime, default=func.now(), nullable=False, comment="变更时间"
    )
