...
labels:
	...
	- "documentation"
document_type: "工具脚本"
usage_scenario: "检查AI工作流程相关文档间的一致性，发现和解决冲突"
usage_method: "powershell -ExecutionPolicy Bypass -File tools/sync_documentation.ps1"
cooperation_docs: "与所有AI工作流程文档配合，确保信息源一致性"
maintenance_note: "文档结构变化时需要更新检查逻辑；新增检查点时需要更新提取规则"
---
...
> **功能说明**: 检查MASTER.md、checkpoint-cards.md、task_classification配置间的一致性，发现冲突并提供修复建议  
> **使用方法**: 在项目根目录运行 `powershell -ExecutionPolicy Bypass -File tools/sync_documentation.ps1`  
> **使用场景**: 文档维护、冲突检查、信息源一致性验证、定期质量检查  
> **配合使用**: 与文档管理标准配合，确保AI工作流程文档的权威性和一致性  
> **更新维护**: 文档结构变化时同步更新检查逻辑；新增文档类型时扩展检查范围
