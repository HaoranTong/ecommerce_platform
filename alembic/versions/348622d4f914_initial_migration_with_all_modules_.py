...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "activity_code", sa.String(length=50), nullable=False, comment="活动代码"
        ),
        sa.Column(
            "activity_name", sa.String(length=100), nullable=False, comment="活动名称"
        ),
        sa.Column(
            "activity_type", sa.String(length=30), nullable=False, comment="活动类型"
        ),
        ...
        sa.Column(
            "max_participants", sa.Integer(), nullable=True, comment="最大参与人数限制"
        ),
    ...
    op.create_index(
        "idx_activity_type", "member_activities", ["activity_type"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_member_activities_id"), "member_activities", ["id"], unique=False
    )
    op.create_index(
        "uk_activity_code", "member_activities", ["activity_code"], unique=True
    )
    op.create_table(
        "membership_levels",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
            ...
            sa.String(length=50),
            nullable=False,
            comment="等级名称，如注册会员、铜牌会员",
        ),
        sa.Column(
            "level_code",
            sa.String(length=20),
            nullable=False,
            comment="等级代码，如BASIC、BRONZE",
        ),
        sa.Column(
            "required_spent",
    ...
    op.create_index(
        "idx_level_order", "membership_levels", ["level_order"], unique=False
    )
    op.create_index(
        "idx_required_spent", "membership_levels", ["required_spent"], unique=False
    )
    op.create_index(
        op.f("ix_membership_levels_id"), "membership_levels", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
        sa.Column(
            "config_key", sa.String(length=100), nullable=False, comment="配置键名"
        ),
        sa.Column(
            "config_name", sa.String(length=200), nullable=False, comment="配置名称"
        ),
        sa.Column(
            "config_category", sa.String(length=50), nullable=False, comment="配置分类"
        ),
    ...
    op.create_index(
        "idx_config_category", "system_configs", ["config_category"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "total_points", sa.BigInteger(), nullable=False, comment="历史累计获得积分"
        ),
        sa.Column(
            "available_points", sa.BigInteger(), nullable=False, comment="当前可用积分"
        ),
        sa.Column("frozen_points", sa.BigInteger(), nullable=False, comment="冻结积分"),
        sa.Column("join_date", sa.Date(), nullable=False, comment="入会日期"),
        sa.Column(
            "last_active_at", sa.DateTime(), nullable=True, comment="最后活跃时间"
        ),
        sa.Column("birthday", sa.Date(), nullable=True, comment="生日"),
        sa.Column(
            "preferences", sa.JSON(), nullable=True, comment="偏好设置(通知、营销等)"
        ),
        sa.Column(
            "status",
            sa.String(length=20),
            nullable=False,
            comment="状态: active=正常, frozen=冻结, cancelled=注销",
        ),
        sa.Column(
            "created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False
        ),
        ...
        sa.CheckConstraint(
            "available_points >= 0", name="check_available_points_non_negative"
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
        sa.Column(
            "benefit_code", sa.String(length=50), nullable=False, comment="权益代码"
        ),
        sa.Column(
            "benefit_name", sa.String(length=100), nullable=False, comment="权益名称"
        ),
        sa.Column(
            "benefit_type", sa.String(length=30), nullable=False, comment="权益类型"
        ),
    ...
    op.create_index(
        "idx_benefit_type", "membership_benefits", ["benefit_type"], unique=False
    )
    op.create_index("idx_level_id", "membership_benefits", ["level_id"], unique=False)
    op.create_index(
        op.f("ix_membership_benefits_id"), "membership_benefits", ["id"], unique=False
    )
    op.create_index(
        "uk_benefit_level",
        "membership_benefits",
        ["benefit_code", "level_id"],
        unique=True,
    )
    op.create_table(
        "orders",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
            "order_number", sa.String(length=32), nullable=False, comment="订单号"
        ),
        ...
        sa.Column(
            "shipping_method", sa.String(length=50), nullable=True, comment="配送方式"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "participation_data", sa.JSON(), nullable=True, comment="参与相关数据"
        ),
    ...
    op.create_index(
        op.f("ix_activity_participations_id"),
        "activity_participations",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "related_order_id", sa.BigInteger(), nullable=True, comment="关联订单ID"
        ),
        sa.Column("usage_details", sa.JSON(), nullable=True, comment="使用详细信息"),
        sa.Column(
            "usage_result", sa.String(length=200), nullable=True, comment="使用结果描述"
        ),
    ...
    op.create_index(
        "idx_member_benefit",
        "benefit_usages",
        ["member_id", "benefit_id"],
        unique=False,
    )
    op.create_index(
        "idx_related_order_id", "benefit_usages", ["related_order_id"], unique=False
    )
    op.create_index("idx_usage_date", "benefit_usages", ["usage_date"], unique=False)
    op.create_index(
        op.f("ix_benefit_usages_id"), "benefit_usages", ["id"], unique=False
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
        sa.Column(
            "transaction_code", sa.String(length=30), nullable=False, comment="交易编号"
        ),
        sa.Column("member_id", sa.BigInteger(), nullable=False, comment="会员ID"),
        sa.Column(
            "transaction_type", sa.String(length=30), nullable=False, comment="交易类型"
        ),
        sa.Column(
            "points_amount",
            sa.BigInteger(),
        ...
        sa.Column(
            "balance_after", sa.BigInteger(), nullable=False, comment="交易后余额"
        ),
        sa.Column(
            "related_order_id", sa.BigInteger(), nullable=True, comment="关联订单ID"
        ),
        sa.Column(
            "related_activity_id", sa.BigInteger(), nullable=True, comment="关联活动ID"
        ),
        sa.Column(
            "description", sa.String(length=200), nullable=True, comment="交易描述"
        ),
        sa.Column(
            "source_system", sa.String(length=50), nullable=True, comment="来源系统"
        ),
        sa.Column(
            "operator_id",
            sa.BigInteger(),
    ...
    op.create_index(
        "idx_created_at", "point_transactions", ["created_at"], unique=False
    )
    op.create_index(
        "idx_expires_at", "point_transactions", ["expires_at"], unique=False
    )
    op.create_index("idx_member_id", "point_transactions", ["member_id"], unique=False)
    op.create_index(
        "idx_related_order_id", "point_transactions", ["related_order_id"], unique=False
    )
    op.create_index(
        "idx_transaction_type", "point_transactions", ["transaction_type"], unique=False
    )
    op.create_index(
        op.f("ix_point_transactions_id"), "point_transactions", ["id"], unique=False
    )
    op.create_index(
        "uk_transaction_code", "point_transactions", ["transaction_code"], unique=True
    )
    op.create_table(
        "product_attributes",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_product_attributes_id"), "product_attributes", ["id"], unique=False
    )
    op.create_table(
        "product_tags",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        "idx_skus_product_active", "skus", ["product_id", "is_active"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "available_quantity", sa.Integer(), nullable=False, comment="可用库存数量"
        ),
        sa.Column(
            "reserved_quantity", sa.Integer(), nullable=False, comment="预占库存数量"
        ),
        sa.Column(
            "warning_threshold", sa.Integer(), nullable=False, comment="库存预警阈值"
        ),
        sa.Column(
            "critical_threshold",
            sa.Integer(),
    ...
    op.create_index(
        "idx_inventory_stocks_available_quantity",
        "inventory_stocks",
        ["available_quantity"],
        unique=False,
    )
    op.create_index(
        "idx_inventory_stocks_sku_id", "inventory_stocks", ["sku_id"], unique=False
    )
    op.create_index(
        "idx_inventory_stocks_warning_threshold",
        "inventory_stocks",
        ["warning_threshold"],
        unique=False,
    )
    op.create_index(
        op.f("ix_inventory_stocks_id"), "inventory_stocks", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_inventory_stocks_sku_id"), "inventory_stocks", ["sku_id"], unique=True
    )
    op.create_table(
        "order_items",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.Column("sku_id", sa.Integer(), nullable=False, comment="SKU ID"),
        sa.Column(
            "sku_code", sa.String(length=100), nullable=False, comment="SKU编码快照"
        ),
        sa.Column(
            "product_name",
        ...
        sa.Column(
            "sku_name", sa.String(length=200), nullable=False, comment="SKU名称快照"
        ),
    ...
    op.create_index(
        op.f("ix_sku_attributes_id"), "sku_attributes", ["id"], unique=False
    )
    op.create_index(
        "uk_sku_attributes_sku_name",
        "sku_attributes",
        ["sku_id", "attribute_name"],
        unique=True,
    )
    op.create_table(
        ...
        sa.Column(
            "reservation_type",
            sa.Enum("CART", "ORDER", name="reservationtype"),
            nullable=False,
            comment="预占类型",
        ),
        sa.Column(
    ...
    op.create_index(
        "idx_inventory_reservations_is_active",
        "inventory_reservations",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        "idx_inventory_reservations_reference_id",
        "inventory_reservations",
        ["reference_id"],
        unique=False,
    )
    op.create_index(
        "idx_inventory_reservations_reservation_type",
        "inventory_reservations",
        ["reservation_type"],
        unique=False,
    )
    op.create_index(
        "idx_inventory_reservations_sku_id",
        "inventory_reservations",
        ["sku_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_inventory_reservations_id"),
        "inventory_reservations",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "quantity_before", sa.Integer(), nullable=False, comment="变动前数量"
        ),
        ...
        sa.Column(
            ...
            sa.String(length=50),
            nullable=True,
            comment="关联类型（order/cart/manual等）",
        ),
        sa.Column(
            "reference_id", sa.String(length=100), nullable=True, comment="关联ID"
        ),
        sa.Column("operator_id", sa.Integer(), nullable=True, comment="操作人ID"),
    ...
    op.create_index(
        "idx_inventory_transactions_operator_id",
        "inventory_transactions",
        ["operator_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_inventory_transactions_sku_id",
        "inventory_transactions",
        ["sku_id"],
        unique=False,
    )
    op.create_index(
        "idx_inventory_transactions_transaction_type",
        "inventory_transactions",
        ["transaction_type"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_inventory_transactions_sku_id", table_name="inventory_transactions"
    )
    op.drop_index(
        "idx_inventory_transactions_reference_id", table_name="inventory_transactions"
    )
    op.drop_index(
        "idx_inventory_transactions_operator_id", table_name="inventory_transactions"
    )
    op.drop_index(
        "idx_inventory_transactions_created_at", table_name="inventory_transactions"
    )
    op.drop_table("inventory_transactions")
    op.drop_index(
        op.f("ix_inventory_reservations_id"), table_name="inventory_reservations"
    )
    op.drop_index(
        "idx_inventory_reservations_sku_id", table_name="inventory_reservations"
    )
    op.drop_index(
        "idx_inventory_reservations_reservation_type",
    ...
    op.drop_index(
        "idx_inventory_reservations_reference_id", table_name="inventory_reservations"
    )
    op.drop_index(
        "idx_inventory_reservations_is_active", table_name="inventory_reservations"
    )
    op.drop_index(
        "idx_inventory_reservations_expires_at", table_name="inventory_reservations"
    )
    ...
    op.drop_index(
        "idx_inventory_stocks_warning_threshold", table_name="inventory_stocks"
    )
    op.drop_index("idx_inventory_stocks_sku_id", table_name="inventory_stocks")
    op.drop_index(
        "idx_inventory_stocks_available_quantity", table_name="inventory_stocks"
    )
    ...
    op.drop_index(
        op.f("ix_activity_participations_id"), table_name="activity_participations"
    )
