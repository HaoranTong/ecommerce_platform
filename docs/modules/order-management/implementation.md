...
@router.post("/order-management/{resource}", response_model={Schema}Response)
...
```python
import pytest
from app.modules.order_management.service import {Module}Service
...
### 依赖注入配置
```python
# app/modules/order_management/dependencies.py
