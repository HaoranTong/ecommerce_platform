...
@router.post("/quality-control/{resource}", response_model={Schema}Response)
...
```python
import pytest
from app.modules.quality_control.service import {Module}Service
...
### 依赖注入配置
```python
# app/modules/quality_control/dependencies.py
