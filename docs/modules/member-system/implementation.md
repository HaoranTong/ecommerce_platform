...
@router.post("/member-system/{resource}", response_model={Schema}Response)
...
```python
import pytest
from app.modules.member_system.service import {Module}Service
...
### 依赖注入配置
```python
# app/modules/member_system/dependencies.py
